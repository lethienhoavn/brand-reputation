...
const ExamplePopup: React.FC<ExamplePopupProps> = ({
  ...
  return (
    <div
      ref={exampleRef}
      className={`absolute -top-14 left-1/2 -translate-x-1/2 ${glassStyle.card} bg-white/90 shadow-lg border-blue-200 cursor-pointer z-10 
    ...
    >
      ...
      <div>
        <span className="text-sm font-medium items-center justify-center text-gray-700 group-hover:text-gray-800 transition-colors">
          Try an example:{" "}
        </span>
        <span
