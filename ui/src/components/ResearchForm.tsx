        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="flex gap-4">
            ...
            <div className="relative flex-grow group">
              <div className="relative">
                ...
                <input
                  ...
                  className={`${glassStyle.input} w-full transition-all duration-300 focus:border-[#468BFF]/50 focus:ring-1 focus:ring-[#468BFF]/50 group-hover:border-[#468BFF]/30 bg-white/80 backdrop-blur-sm text-lg py-4 pl-12 font-['DM_Sans']`}
            ...
            <button
              ...
              className="relative group overflow-hidden rounded-lg bg-white/80 backdrop-blur-sm border border-gray-200 transition-all duration-500 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed px-6 font-['DM_Sans']"
            >
